...
@AutoService(KeyMappingFactoryProvider::class)
internal class NeoForgeKeyMappingFactoryProvider : KeyMappingFactoryProvider {
    override fun get(): KeyMappingFactory = NeoForgeKeyMappingFactory()
}