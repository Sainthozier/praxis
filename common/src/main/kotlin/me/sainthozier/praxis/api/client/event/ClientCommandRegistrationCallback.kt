...
package me.sainthozier.praxis.api.client.event
...
object ClientCommandRegistrationCallback {

    @JvmField
    val EVENT: Event<Registrar> = EventFactory.broadcast()

    fun interface Registrar {
        fun onCommandRegistration(
